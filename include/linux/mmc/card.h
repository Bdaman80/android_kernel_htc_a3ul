...
#define MMC_STATE_DOING_SANITIZE (1<<29)       /* card is doing sanitize. */
#define MMC_STATE_FORCE_SANITIZE (1<<30)        /* card need to do SANITIZE */
#define MMC_STATE_FORCE_BKOPS   (1<<31)         /* card should do BKOPS in suspend mode */
